...
//533191/6809/2.38/14/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AS5047D-ATSM" (originalName "AS5047D-ATSM")
	...
	(compDef "AS5047D-ATSM" (originalName "AS5047D-ATSM") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AS5047D-ATSM"))
		...
		(attr "RS Part Number" "1700756")
		(attr "RS Price/Stock" "http://uk.rs-online.com/web/p/products/1700756")
		(attr "Manufacturer_Name" "ams")
		(attr "Manufacturer_Part_Number" "AS5047D-ATSM")
		(attr "Description" "ams AS5047D-ATSM Hall Effect Sensor 14-Pin TSSOP, 3  3.6 V, 4.5  5.5 V")
		(attr "<Hyperlink>" "http://uk.rs-online.com/web/p/products/1700756")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "AS5047D-ATSM.stp")
	)
